'use client';
// app/(portal)/portal/PortalShell.tsx
...
const NAV_ITEMS = [
  { label: 'Browse Units', href: '/portal', exact: true, icon: '🏠' },
...
export default function PortalShell({ userName, children }: Props) {
    ...
    <div className='min-h-screen bg-zinc-950 text-white flex'>
      ...
      >
        ...
        <div className='px-6 py-5 border-b border-zinc-800'>
          ...
          <p className='text-xs text-zinc-500 mt-0.5'>Tenant Portal</p>
        </div>
