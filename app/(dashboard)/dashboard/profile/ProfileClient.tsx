...
type User = {
  ...
  role: string;
  pref_min_budget: string | number | null;
  pref_max_budget: string | number | null;
      ...
      <div className='max-w-4xl mx-auto px-6 py-12 space-y-10'>
        ...
        <div className='flex items-center gap-5'>
          {avatarUrl ? (
            ...
            <div className='w-18 h-18 w-[72px] h-[72px] rounded-full bg-indigo-600 flex items-center justify-center text-2xl font-bold'>
              {getInitials(name)}
            </div>
          )}
          <div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
            ...
            <div>
              ...
              <input
                value={user.email}
                disabled
                className='w-full bg-zinc-800/50 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-zinc-500 cursor-not-allowed'
              />
            </div>
            <div>
        ...
        <section className='bg-zinc-900 border border-zinc-800 rounded-2xl p-6 space-y-5'>
          <div>
            ...
            <p className='text-xs text-zinc-500 mt-0.5'>
              Used to help surface the best listings for you.
            </p>
          </div>
